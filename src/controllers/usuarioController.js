...
function cadastrar_voto2(req, res) {
    ...
    if (voto_personagem == undefined) {
        ...
        // Passe os valores como parâmetro e vá para o arquivo usuarioModel.js
        usuarioModel.cadastrar_voto2(voto_personagem, fk_usuario)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
...
function cadastrar_voto3(req, res) {
    ...
    if (voto_personagem == undefined) {
        ...
        // Passe os valores como parâmetro e vá para o arquivo usuarioModel.js
        usuarioModel.cadastrar_voto3(voto_personagem, fk_usuario)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
...
function pegar_voto(req, res) {
    usuarioModel.pegar_voto()
        .then(function (resultado) {
            if (resultado.length > 0) {
                res.status(200).json(resultado);
            } else {
...
function pegar_voto2(req, res) {
    usuarioModel.pegar_voto2()
        .then(function (resultado) {
            if (resultado.length > 0) {
                res.status(200).json(resultado);
            } else {
...
function pegar_voto3(req, res) {
    usuarioModel.pegar_voto3()
        .then(function (resultado) {
            if (resultado.length > 0) {
                res.status(200).json(resultado);
            } else {
